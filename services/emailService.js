...
const sendTicketEmail = async (ticketData) => {
    try {
        ...
        const msg = {
            to: ticketData.email,
            from: {
                name: 'Action SA Students Chapter Pool Party',
                ...
                <div style="margin:0; padding:0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
                    <div style="max-width:600px; margin:0 auto; background-color:#ffffff; border-radius:8px; overflow:hidden;">
                        ...
                        <div style="background-color:#009739; padding:30px; text-align:center; color:white;">
                            <img src="https://yourcdn.com/action-sa-logo.png" alt="Action SA Logo" style="height:60px; margin-bottom:10px;">
                        ...
                        <div style="padding:30px;">
                            ...
                            <div style="background:#f9f9f9; padding:20px; border-radius:8px; margin:20px 0; border-left:4px solid #009739;">
                                ...
                                <p><strong>Date:</strong> 04 October 2025</p>
                                <p><strong>Time:</strong> Starts at 12:00</p>
                            ...
                            <p style="color:#333; line-height:1.6;">
                                For inquiries, please contact <strong>Alvin Maluleke</strong> @ 
                                <a href="tel:0823066975" style="color:#009739; text-decoration:none;">082 306 6975</a>.
                            </p>
                            <!-- Footer Message -->
